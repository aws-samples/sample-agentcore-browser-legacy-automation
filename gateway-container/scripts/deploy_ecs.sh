...
# =============================================================================
# Deploy Concierge Gateway to ECS Fargate via Terraform
# =============================================================================
# Runs terraform init + apply against the deploy/ configuration
# using user-terraform.tfvars (or a custom var file).
#
# USAGE:
#   ./scripts/deploy_ecs.sh                          # default: user-terraform.tfvars
#   ./scripts/deploy_ecs.sh my-custom.tfvars         # custom var file
#   PLAN_ONLY=true ./scripts/deploy_ecs.sh           # plan without applying
#
...
echo "============================================================"
echo "Concierge Gateway — Terraform Deployment (ECS Fargate)"
echo "============================================================"
echo ""
echo "Configuration:"
...
if [ ! -f "$VAR_FILE_PATH" ]; then
    ...
    echo ""
    echo "Create one from the sample:"
    echo "  cp $DEPLOY_DIR/terraform.tfvars.sample $VAR_FILE_PATH"
